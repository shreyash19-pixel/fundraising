...
const Mobile = () => {
  return (
    <MobileContainer>
      <MobileWrap>
        <MobileInfoWrap>
          <MobileHeading>Apps</MobileHeading>
          <MobileTagline>
            Donating is easier just by using a smartphone
          </MobileTagline>
          <MobileDesc>
            Donating can now be done anywhere, anytime and very easily just by
            using a smartphone, download now for free
          </MobileDesc>
          <MobileBtnWrap>
            <MobileBtn
              href="https://play.google.com/store/apps/details?id=com.shopwithscrip.app&hl=en&gl=US"
              target="_blank"
            >
              Download now
            </MobileBtn>
